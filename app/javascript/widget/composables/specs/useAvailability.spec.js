...
describe('useAvailability', () => {
  const originalWindow = window.deskflowsWebChannel;
  ...
  afterEach(() => {
    window.deskflowsWebChannel = originalWindow;
  });
  ...
  describe('config changes', () => {
    it('should react to window.deskflowsWebChannel changes', () => {
