...
const isADeskFlowsInstance = computed(
  () => globalConfig.value.installationName === 'DeskFlows'
);

onBeforeMount(() => {
  isLoading.value = isADeskFlowsInstance.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': isADeskFlowsInstance }"
    >
