...
const isADeskFlowInstance = computed(
  () => globalConfig.value.installationName === 'DeskFlow'
);

onBeforeMount(() => {
  isLoading.value = isADeskFlowInstance.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': isADeskFlowInstance }"
    >
