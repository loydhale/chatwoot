...
export function useBranding() {
  ...
  /**
   * Replaces "DeskFlow" in text with the installation name from global config
   * @param {string} text - The text to process
   * @returns {string} - Text with "DeskFlow" replaced by installation name
   */
  const replaceInstallationName = text => {
    ...
    return text.replace(/DeskFlow/g, installationName);
  };
