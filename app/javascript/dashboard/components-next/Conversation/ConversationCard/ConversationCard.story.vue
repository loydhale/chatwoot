...
const conversationWithoutMeta = {
  ...
  messages: [
    {
      ...
      conversation: {
        ...
        contactInbox: {
          sourceId: 'candice@deskflows.app',
        },
      },
    },
  ],
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      contact_inbox: {
        source_id: 'candice@deskflows.app',
      },
    },
    sender: {
      id: 1,
