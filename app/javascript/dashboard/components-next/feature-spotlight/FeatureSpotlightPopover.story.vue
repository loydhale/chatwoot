      ...
      <div class="p-6 h-[450px] bg-n-background">
        <div class="flex gap-8">
          <FeatureSpotlightPopover
            ...
            title="Hudley Assistant"
            note="Hudley Assistant engages directly with customers, learns from your help docs and past conversations, and delivers instant, accurate responses. It handles the initial queries, providing quick resolutions before transferring to an agent when needed."
            video-url=""
            thumbnail=""
            ...
            learn-more-url="https://www.deskflows.app/hc/user-guide/articles/1738101547-creating-an-assistant-with-captain"
          />
        </div>
      </div>
    </Variant>
