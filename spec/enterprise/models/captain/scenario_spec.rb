...
RSpec.describe Atlas::Scenario, type: :model do
  describe 'associations' do
    it { is_expected.to belong_to(:assistant).class_name('Atlas::Assistant') }
  ...
  describe 'custom tool integration' do
    ...
    describe '#resolve_tool_instance' do
      ...
      it 'returns static tool instance for non-custom tools' do
        ...
        expect(tool_instance).not_to be_a(Atlas::Tools::HttpTool)
      end
    end
    ...
    describe '#agent_tools' do
      it 'returns array of tool instances including custom tools' do
        ...
        expect(tools.first).to be_a(Atlas::Tools::HttpTool)
      end
      ...
      it 'returns mixed static and custom tool instances' do
        ...
        expect(tools.last).to be_a(Atlas::Tools::HttpTool)
      end
    end
  end
