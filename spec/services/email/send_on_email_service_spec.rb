...
describe Email::SendOnEmailService do
  ...
  describe '#perform' do
    ...
    context 'when an error occurs' do
      ...
      let(:exception_tracker) { instance_double(DeskFlowExceptionTracker, capture_exception: true) }
      ...
      it 'captures the exception' do
        expect(DeskFlowExceptionTracker).to receive(:new).with(error, account: message.account)
