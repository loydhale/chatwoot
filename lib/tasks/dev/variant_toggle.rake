...
namespace :deskflows do
  namespace :dev do
    desc 'Toggle between DeskFlows variants with interactive menu'
    ...
    desc 'Show current DeskFlows variant status'
    ...
    def show_current_variant
      puts "\n#{('=' * 50)}"
      puts '🚀 DESKFLOWS VARIANT MANAGER'
      puts '=' * 50
