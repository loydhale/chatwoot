module Redis::RedisKeys
  ...
  DESKFLOWS_INSTALLATION_ONBOARDING = 'DESKFLOWS_INSTALLATION_ONBOARDING'.freeze
  DESKFLOWS_INSTALLATION_CONFIG_RESET_WARNING = 'DESKFLOWS_CONFIG_RESET_WARNING'.freeze
  LATEST_DESKFLOWS_VERSION = 'LATEST_DESKFLOWS_VERSION'.freeze
