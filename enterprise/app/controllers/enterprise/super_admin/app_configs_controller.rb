module Enterprise::SuperAdmin::AppConfigsController
  ...
  def internal_config_options
    %w[DESKFLOWS_INBOX_TOKEN DESKFLOWS_INBOX_HMAC_KEY CLOUD_ANALYTICS_TOKEN CLEARBIT_API_KEY DASHBOARD_SCRIPTS INACTIVE_WHATSAPP_NUMBERS
       SKIP_INCOMING_BCC_PROCESSING CAPTAIN_CLOUD_PLAN_LIMITS ACCOUNT_SECURITY_NOTIFICATION_WEBHOOK_URL DESKFLOWS_INSTANCE_ADMIN_EMAIL
