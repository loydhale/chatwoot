class Atlas::Tools::SimplePageCrawlParserJob < ApplicationJob
  queue_as :low

  def perform(assistant_id:, page_link:)
    assistant = Atlas::Assistant.find(assistant_id)
    ...
    crawler = Atlas::Tools::SimplePageCrawlService.new(page_link)
